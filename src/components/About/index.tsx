    ...
    return (
        <section className='container-about' id='about'>
            ...
            <div className='text-about'>
                ...
                <img src={logo} alt="" height={250} style={{ borderRadius: '50%' }} />

                <div style={{ textAlign: 'center', margin: '0 auto', justifyContent: 'center' }}>
                    <h3 style={{ textAlign: 'center' }}>E temos um diferencial</h3>
                ...
                <BtnGet nameButton="Fazer Orçamento" className='btnMeio' />

                <h3 style={{ color: '#000', textAlign: 'center', marginTop: '45px' }}>Por que escolher a LC Refrigeração?</h3>
